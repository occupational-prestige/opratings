...
# writeBin(get_file("TDA_data_scored.tab", "doi:10.7910/DVN/G1E4BF"), "opratings.tab")
# opratings.tab <- fread("opratings.tab", na.strings=getOption("<NA>","NA"))
# opratings <- as.data.frame(opratings.tab)
# rm(opratings.tab)
